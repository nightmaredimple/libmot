...
def get_version():
    version_file = 'libmot/version.py'
...
if __name__ == '__main__':
    setup(
        name='libmot',
        version=get_version(),
        description='A Library of Multi-Object Tracking in Python and Pytorch',
        long_description=readme(),
        keywords='multi-object tracking',
        packages=find_packages(),
        url='https://github.com/nightmaredimple/libmot',
        author='Piao Huang',
